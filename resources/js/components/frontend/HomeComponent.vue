<template>
    <div class="mt-5">
        <div class="section_our_solution">
            <div class="row">
                <div v-for="quiz in quizzez" class="col-lg-12 col-md-12 col-sm-12">
                    <div class="our_solution_category">
                        <div class="solution_cards_box">
                            ...
                            <div class="solu_description">
                                <p>
                                    Welcome to the world’s largest quiz community. Play a quiz or create your own. Join a virtual or live event.
                                </p>
                                <a :href="'/quiz/play/'+quiz.quiz_id"><button type="button" class="read_more_btn">Play</button></a>
                            </div>
                            </div>
                        </div>
                    </div>
...
<script>
    ...
    methods: {
        getQuizzes () {
            this.loading = true;
            axios.get("/quiz/active").then((response) => {
